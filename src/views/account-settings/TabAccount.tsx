...
import ProfilePhotoDialog from 'src/pages/components/ProfilePhotoDialog'
...
const TabAccount: React.FC<TabAccountProps> = ({ userData }) => {
  // ** State
  ...
  const handleInputImageReset = () => {
    setInputValue('')
    setImgSrc(`/images/avatars/${formData.avatar}.png`)
  }
    ...
    <Grid container spacing={6}>
      ...
      <Grid item xs={12}>
        <Card>
          ...
          {/* <FileUpload /> */}
          {/* <ProfilePhotoDialog defaultPhoto='\public\images\avatars\6.png' /> */}
          <form>
            <CardContent sx={{ pt: 0 }}>
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <ImgStyled src={`/images/avatars/${formData.avatar}.png`} alt='Profile Pic' />
                <div>
              ...
              <Grid container spacing={6}>
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    onChange={e => handleFormChange('f_name', e.target.value)}
                  />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    onChange={e => handleFormChange('l_name', e.target.value)}
                  />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <TextField
