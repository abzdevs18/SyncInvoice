      ...
      <Card>
            ...
            <Grid item sm={6} xs={12} sx={{ mb: { sm: 0, xs: 4 } }}>
              <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <Box>
                  ...
                  <Typography variant='body2' sx={{ mb: 1 }}>
                    Negros Oriental, Dauin, Philippines
                  </Typography>
                  <Typography variant='body2'>+63905 431 9632</Typography>
                </Box>
              </Box>
            </Grid>
        ...
        <CardContent>
          <Grid container>
            ...
            <Grid item xs={12} sm={6} sx={{ display: 'none', justifyContent: ['flex-start', 'flex-end'] }}>
              <div>
                <Typography variant='subtitle2' sx={{ mb: 3, color: 'text.primary', letterSpacing: '.1px' }}>
                  Bill To:
                </Typography>
        ...
        <TableContainer>
          <Table>
            ...
            <TableBody>
              <TableRow>
                <TableCell>Tuition One</TableCell>
              ...
              <TableRow>
                <TableCell>Miscellaneous II</TableCell>
                <TableCell>Sample miscellaneous</TableCell>
                <TableCell>42</TableCell>
                <TableCell>1</TableCell>
                <TableCell>$28</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Miscellaneous III</TableCell>
                <TableCell>Miscellaneous package IV</TableCell>
                <TableCell>46</TableCell>
                <TableCell>1</TableCell>
                <TableCell>$24</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Miscellaneous & Tuition Sample Data</TableCell>
                <TableCell>Ave. Miscellaneous Fee</TableCell>
        ...
        <CardContent sx={{ pt: 8 }}>
          <Grid container>
            <Grid item xs={12} sm={7} lg={9} sx={{ order: { sm: 1, xs: 2 } }}>
              <Box sx={{ mb: 2, display: 'none', alignItems: 'center' }}>
                <Typography
                  variant='body2'
