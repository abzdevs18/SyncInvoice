...
mock.onGet('/apps/permissions/data').reply(config => {
  ...
  const filteredData = data.permissions.filter(
    permissions =>
      permissions.permissionName.toLowerCase().includes(queryLowered) ||
