...
import StudentStepAccountDetails from 'src/views/pages/student-application/StepStudentAccountDetails'
...
const steps = [
  ...
  {
    title: 'Accomodation',
    subtitle: 'Living Accomodation & Travel'
  }
]

const StudentRegisterMultiSteps = () => {
  // ** States
  ...
  const getStepContent = (step: number) => {
    switch (step) {
      case 0:
        return <StudentStepAccountDetails handleNext={handleNext} />
      case 1:
...
export default StudentRegisterMultiSteps
