...
const columns = [
  {
    ...
    renderCell: ({ row }: CellType) => {
      const { f_name, l_name, u_name } = row
        ...
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column' }}>
            <Typography
              ...
              component={Link}
              variant='subtitle2'
              href={`/apps/user/view/overview/${row.id}`}
              sx={{
                fontWeight: 600,
                color: 'text.primary',
                textDecoration: 'none',
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => {
      return (
        <Box sx={{ display: 'flex', alignItems: 'center', '& svg': { mr: 3, color: '#333' } }}>
  ...
  },
  {
    ...
    headerName: 'Actions',
    renderCell: row => (
      <IconButton component={Link} href={`/apps/user/view/overview/${row.id}`}>
